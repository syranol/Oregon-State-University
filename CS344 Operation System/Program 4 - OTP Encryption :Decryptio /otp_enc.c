...
int main(int argc, char *argv[])
{
    ...
    //* input, inputsize
    int pTxt = open(argv[1], O_RDONLY);
    int pTxtSize = lseek(pTxt, 0 , SEEK_END);
    //* keygen, keygenSize
...
int prepNect(char* arg3)
{
    ...
    if(strcmp(currentCheck, "_"/*checks for ! */) != 0)
    {
    ...
    {
        fprintf(stderr, "Error: connection rejected between opt_dec_d and otp_enc");
        exit(2);
    }
